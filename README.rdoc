...
# Between seconds 1-9, move the sprite across the screen...
# rotate it 360 degrees at the same time, 
# and when it's done, play a sound woff. 
# Without the ".after."-chaining the sound would have been played after 1 seconds, not 10.
